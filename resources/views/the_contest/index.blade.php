...
<div class="d-flex flex-column h-100vh align-items-center justify-content-center text-light" style="background-image:url({{$contest->background_image}})">
    <div class="container text-center my-4">
        ...
        @if(\Carbon\Carbon::create(2018, 7, 30, 0, 0, 0, 'America/Toronto')->lt(\Carbon\Carbon::now()))
    ...
    <div class="d-flex justify-content-center">
        ...
        @endif
        @else
        <a class="btn btn-primary btn-wedcontest @if(\Carbon\Carbon::create(2018, 7, 30, 0, 0, 0, 'America/Toronto')->gt(\Carbon\Carbon::now())) mr-4 @endif" href="{{route("login")}}">@lang('contests.login_button')</a>
