<template>
  <div>
    ...
    <div v-if="language==='en'">
      ...
      <div class="py-2">
        ...
        <image-uploader name="logo_image" class="mr-1" v-model="form.en.logo_image" :cropperOptions="cropperLogoOptions"></image-uploader> 
      </div>
    ...
    <div v-if="language==='es'">
      ...
      <div class="py-2">
        ...
        <image-uploader name="logo_imagen" class="mr-1" v-model="form.es.logo_image" :cropperOptions="cropperLogoOptions"></image-uploader> 
      </div>
  ...
  <div class="py-2"> 
    ...
    <div class="d-flex">
      ...
      <switches v-model="form.normalCategories" id="normalCategories" theme="bootstrap" color="blue"></switches>
  ...
  <div class="py-2">
    <button type="button" class="btn btn-wedcontest" @click="createContest">Create</button>
  </div>
</div>
</template>
...
export default {
  ...
  watch:{
    'form.en.topic':function(newVal){
      this.form.slug=this.sanitize(newVal);
    }
  }
