		...
		<div class="row">
			<div class="col col-md-4">
				...
				<div class="form-group">
					...
					<wysiwyg :id="'en'+artwork.id" :name="'en'+artwork.id"  :ref="'en'+artwork.id" v-model="translations.en.description" required>
					</wysiwyg>
					<transition name="zoom" enter-active-class="zoomIn" leave-active-class="zoomOut">
			...
			<div class="col col-md-4">
				...
				<div class="form-group">
					...
					<wysiwyg :id="'es'+artwork.id" :name="'es'+artwork.id"  :ref="'es'+artwork.id" v-model="translations.es.description" required>
					</wysiwyg>
					<transition name="zoom" enter-active-class="zoomIn" leave-active-class="zoomOut">
						<div class="text-red" v-if="artwork.description===''">{{$t('lang.required')}}</div>
					</transition>
